...
export const technologyPartnershipIntro =
...
export const technologyCommercialGroups: TechnologyGroup[] = [
  {
  ...
  },
  {
    ...
    items: ['North American Representation', 'International Business Development', 'Market Entry Strategy', 'EPC Engagement', 'Owner Engagement', 'Strategic Partnerships', 'Opportunity Identification', 'Proposal Development']
  },
  {
...
export const technologyEcosystemGroups: TechnologyGroup[] = [
  {
  ...
  },
  {
    ...
    items: ['Siemens (TIA Portal, PCS 7)', 'Rockwell Automation (FactoryTalk, Studio 5000)', 'Schneider Electric (EcoStruxure)', 'Emerson (DeltaV)', 'Honeywell (Experion PKS)', 'ABB (800xA)', 'Yokogawa (CENTUM VP)']
  },
  {
    heading: 'Cloud & AI',
  ...
  },
  {
    ...
    items: ['AVEVA PI System / CONNECT', 'Siemens Xcelerator', 'Bentley iTwin', 'Hexagon Digital Twin', 'Azure Digital Twins', 'NVIDIA Omniverse', 'Dassault 3DEXPERIENCE', 'Autodesk Tandem']
  },
  {
    heading: 'Cybersecurity for OT',
    items: ['Nozomi Networks', 'Claroty', 'Dragos', 'Microsoft Defender for IoT', 'Palo Alto Networks (Industrial OT)', 'Fortinet OT Security', 'Cisco Cyber Vision', 'Tenable OT']
  },
  {
    heading: 'Future Technologies',
    items: ['NVIDIA Omniverse', 'Microsoft Copilot', 'OpenAI', 'Google Gemini', 'Anthropic Claude', 'Boston Dynamics', 'Figure AI', 'Unity Industry', 'Unreal Engine', 'NVIDIA Isaac Robotics']
  }
];
